...
from rs_core.online.recall.candidate_store.base import CandidateStore, MAX_QUERY_LIMIT, SafeCandidateStore, safe_error_status
...
class CassandraCandidateStore:
    ...
    def health(self) -> dict[str, Any]:
        try:
            ...
            return safe_error_status("unavailable", exc, backend="cassandra") | {
