...
@dataclass
class CandidateStoreUserCFProvider:
    config: dict[str, Any]
    store: CandidateStore
    enabled: bool = True
    name: str = "candidate_store_usercf"
    role: str = "online_usercf_recall"
    source_name: str = "usercf_recall"

    @classmethod
    def from_config(cls, provider_config: dict[str, Any], *, provider_name: str | None = None) -> "CandidateStoreUserCFProvider":
        ...
        return cls(
            ...
            name=provider_name or str(config.get("name", "candidate_store_usercf")),
