...
@dataclass
class PostgresItemNeighborsProvider:
    config: dict[str, Any]
    store: CandidateStore
    enabled: bool = True
    name: str = "postgres_item_neighbors"
    role: str = "online_item_neighbor_recall"
    source_name: str = "item_neighbors"

    @classmethod
    def from_config(cls, provider_config: dict[str, Any], *, provider_name: str | None = None) -> "PostgresItemNeighborsProvider":
        ...
        return cls(
            ...
            name=provider_name or str(config.get("name", "postgres_item_neighbors")),
