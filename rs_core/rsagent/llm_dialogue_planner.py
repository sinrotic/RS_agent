...
from rs_core.rsagent.dialogue import DialoguePlan
...
def _build_messages(user_input: str, session: AgentSession, fallback_plan: DialoguePlan, explanation_item_id: str | None) -> list[dict[str, str]]:
    ...
    return [
        ...
        {"role": "system", "content": "Return exactly one JSON object compatible with the provided output_contract. Keep assistant_response public-safe."},
