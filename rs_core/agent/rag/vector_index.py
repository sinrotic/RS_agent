...
from rs_core.agent.rag.corpus import RAG_COMPACT_DENSE_FIELD
    ...
    def _load_model(self) -> Any:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "install the training optional dependencies with `pip install -e \".[training]\"` "
                "or use vector_method='tfidf'."
            ) from exc
