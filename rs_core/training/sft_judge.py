...
from rs_core.training.data_contracts import SFT_SAMPLE_SCHEMA_VERSION, validate_sft_sample
...
def _validate_multi_turn(record: dict[str, Any]) -> None:
    from rs_core.training.multi_turn_sft_generator import validate_multi_turn_sft_sample
