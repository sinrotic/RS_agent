...
DEFAULT_BOUNDARY_MAP: Final[BoundaryMap] = BoundaryMap(
    modules=(
        ...
        BoundaryModule(
            name="FastAPIApp",
            responsibility="Expose FastAPI endpoints, app assembly, dependencies, middleware, and exception translation without directly owning external infrastructure clients.",
            ...
            forbidden_imports=("redis", "minio", "qdrant_client", "psycopg"),
            required_tests=("tests/test_serving_smoke.py", "tests/test_serving_reorg_compatibility.py"),
            compatibility_paths=(),
        ),
        BoundaryModule(
        ...
        BoundaryModule(
            ...
            owned_paths=("rs_core/rsagent/runtime.py", "rs_core/workflow/hybrid_environment.py", "rs_core/workflow/online_recommendation.py"),
            allowed_imports=("rs_core.recsys", "rs_core.rsagent", "rs_core.serving.domain.adapter_contracts", "rs_core.workflow"),
            forbidden_imports=("rq", "celery", "airflow"),
            required_tests=("tests/test_serving_smoke.py", "tests/test_rag_core.py"),
        ),
        BoundaryModule(
        ...
        BoundaryModule(
            ...
            forbidden_imports=("redis", "minio", "qdrant_client"),
            required_tests=("tests/test_serving_persistence.py", "tests/test_serving_store_contracts.py"),
        ),
        BoundaryModule(
            name="InfrastructureBackends",
            responsibility="Represent Store, Cache, Artifact, Knowledge, and Task backend capabilities only through adapter protocols.",
            owned_paths=("rs_core/serving/infrastructure/",),
