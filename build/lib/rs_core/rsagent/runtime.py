...
class AgentRuntime:
    ...
    def run_turn(
        ...
        tool_reports = [self._execute_agent_tools(host, session, plan, "pre_recommendation", None)]
        ...
        tool_reports.append(self._execute_agent_tools(host, session, plan, "post_recommendation", turn))
