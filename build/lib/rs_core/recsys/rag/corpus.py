...
RAG_STANDARD_FIELDS = ["title", "category", "main_category", "category_path", "description", "features"]
RAG_COMPACT_DENSE_FIELD = "compact_text"
RAG_COMPACT_DENSE_SOURCE_FIELDS = ["title", "main_category", "category", "category_path", "description", "features", "full_text"]
