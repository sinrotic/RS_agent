...
def test_call_rag_agent_argument_validation_rejects_low_level_rag_fields():
    ...
    provider = validate_call_rag_agent_arguments({"stage": "pre_retrieval_query_support", "query": "home office", "provider": "milvus"}, "pre_recommendation")
    ...
    legacy_value = validate_call_rag_agent_arguments({"stage": "pre_retrieval_query_support", "query": "home office", "reason": "use retrieval evidence"}, "pre_recommendation")
