...
- `rs_core/online/recall/source_registry/registry.py`
...
- 更新 `configs/recall/pool500_method_registry.json`、`rs_core/online/recall/source_registry/registry.py`、对应 `source_config.yaml`，并保证三者状态一致。
