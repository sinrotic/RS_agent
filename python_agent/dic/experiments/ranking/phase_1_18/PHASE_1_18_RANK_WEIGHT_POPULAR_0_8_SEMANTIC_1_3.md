...
| category_diversity_avg | 2.436325 |
...
- topk_source_coverage: `{"category": 1910, "itemcf_strong": 1019, "itemcf_weak": 1045, "popular": 5805, "semantic": 5342, "two_tower": 1812}`
...
```json
{
  ...
  "evidence": {
    ...
    "ranking_p95_seconds": 0.000879,
    "candidate_generation_p95_seconds": 0.520434
  }
}
```
...
```json
{
  "candidate_generation_avg_seconds": 0.198136,
  "candidate_generation_p95_seconds": 0.520434,
  "ranking_avg_seconds": 0.000602,
  "ranking_p95_seconds": 0.000879,
  "recommendation_avg_seconds": 0.198765,
  "recommendation_p95_seconds": 0.521213,
  "total_run_seconds": 470.03903
}
```
...
- semantic_only_items_above_share: 0.595381
- top1_score_gap_avg: 17.593143
...
- strategy: phase_1_18_rank_weight_popular_0_8_semantic_1_3
- risk_flags: none
- items:
...
- items:
  - B01K8B8YA8 score=44.199954 sources=popular
  - B075X8471B score=39.196862 sources=popular
  - B07W3Q9X9B score=38.533072 sources=semantic,two_tower
  - B0B8SDY8F6 score=38.495574 sources=semantic,two_tower
