...
| candidate_hit_rank_avg | 22.681159 |
| candidate_hit_rank_p50 | 18.0 |
| candidate_hit_rank_p90 | 55.0 |
| candidate_hit_missed_topk_users | 54 |
| ranked_hit_users | 15 |
| recall_at_k | 0.005608 |
...
| hybrid_no_itemcf_hit_rate_at_k | 0.025245 |
| category_diversity_avg | 2.47265 |
...
- topk_source_coverage: `{"category": 1981, "itemcf_strong": 1019, "itemcf_weak": 1045, "popular": 7164, "semantic": 3979, "two_tower": 1436}`
- per_source_candidate_contribution: `{"category": 7, "itemcf_strong": 1, "itemcf_weak": 1, "popular": 15, "semantic": 70, "two_tower": 15}`
- per_source_topk_contribution: `{"category": 3, "popular": 4, "semantic": 11, "two_tower": 1}`
...
- semantic_only_items_above_share: 0.575603
- top1_score_gap_avg: 18.882685
- target_source_combinations: `{"category+popular": 4, "itemcf_strong+itemcf_weak": 1, "popular": 7, "semantic": 51, "semantic+two_tower": 4, "two_tower": 10}`
- items_above_source_combinations: `{"semantic": 1241, "popular": 422, "category+popular": 124, "semantic+two_tower": 110, "two_tower": 110, "itemcf_strong+itemcf_weak": 89, "itemcf_strong": 13, "itemcf_weak": 11, "category+semantic": 7, "category+popular+semantic": 5, "popular+semantic": 4, "popular+two_tower": 4, "category+popular+two_tower": 4, "itemcf_strong+itemcf_weak+semantic": 3, "category+two_tower": 2, "category+itemcf_strong+itemcf_weak+popular+semantic": 2, "itemcf_strong+semantic": 2, "category+itemcf_strong+itemcf_weak+popular": 1, "itemcf_weak+semantic+two_tower": 1, "itemcf_strong+itemcf_weak+popular": 1}`
...
- strategy: phase_1_17b_rank_weight_popular_0_85
- risk_flags: none
- items:
  - B071VDV7NC score=54.298589 sources=category,semantic,popular
...
- risk_flags: none
- items:
  - B01K8B8YA8 score=45.749954 sources=popular
  - B075X8471B score=40.596862 sources=popular
  - B013EKI2DY score=35.203283 sources=semantic,popular
  - B07KTYJ769 score=34.100264 sources=popular
