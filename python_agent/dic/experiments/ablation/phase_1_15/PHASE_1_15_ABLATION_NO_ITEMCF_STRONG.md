...
| category_diversity_avg | 2.431197 |

## Fallback and Source Coverage

- fallback_rate: 0.0
- recall_source_coverage: `{"category": 39664, "itemcf_weak": 16498, "popular": 113312, "semantic": 63960, "two_tower": 35712}`
- topk_source_coverage: `{"category": 2100, "itemcf_weak": 1060, "popular": 8458, "semantic": 2702, "two_tower": 1214}`
- per_source_candidate_contribution: `{"category": 10, "itemcf_weak": 1, "popular": 24, "semantic": 73, "two_tower": 10}`
- per_source_topk_contribution: `{"category": 3, "popular": 4, "semantic": 10, "two_tower": 1}`
- source_overlap: `{"single_source_candidate_count": 191337, "multi_source_candidate_count": 37835, "multi_source_candidate_rate": 0.165094, "source_pair_counts": {"category+itemcf_weak": 141, "category+popular": 23318, "category+semantic": 899, "category+two_tower": 2153, "itemcf_weak+popular": 241, "itemcf_weak+semantic": 118, "itemcf_weak+two_tower": 327, "popular+semantic": 435, "popular+two_tower": 2417, "semantic+two_tower": 12230}}`
...
```json
{
  ...
  "evidence": {
    ...
    "candidate_hit_rank_p90": 62.0,
    "fallback_rate": 0.0,
    "multi_source_candidate_rate": 0.165094,
    "ranking_p95_seconds": 0.000733,
    "candidate_generation_p95_seconds": 0.485056
  }
}
```
...
```json
{
  "candidate_generation_avg_seconds": 0.192793,
  "candidate_generation_p95_seconds": 0.485056,
  "ranking_avg_seconds": 0.000571,
  "ranking_p95_seconds": 0.000733,
  "recommendation_avg_seconds": 0.193392,
  "recommendation_p95_seconds": 0.485662,
  "total_run_seconds": 457.556404
}
```
...
- candidate_hit_rank_p50: 20.5
- candidate_hit_rank_p90: 62.0
- candidate_hit_source_coverage: `{"category": 10, "itemcf_weak": 1, "popular": 24, "semantic": 73, "two_tower": 10}`
...
- semantic_only_items_above_share: 0.558538
- top1_score_gap_avg: 21.732962
- target_source_combinations: `{"category": 1, "category+popular": 6, "itemcf_weak": 1, "popular": 14, "semantic": 58, "semantic+two_tower": 4, "two_tower": 5}`
- items_above_source_combinations: `{"semantic": 1436, "popular": 652, "category+popular": 205, "semantic+two_tower": 126, "itemcf_weak": 47, "two_tower": 27, "popular+two_tower": 22, "category": 15, "category+popular+two_tower": 9, "category+popular+semantic": 8, "category+semantic": 8, "popular+semantic": 5, "itemcf_weak+semantic": 3, "category+itemcf_weak+popular+semantic": 2, "category+itemcf_weak+popular": 1, "itemcf_weak+semantic+two_tower": 1, "category+two_tower": 1, "itemcf_weak+popular": 1, "category+popular+semantic+two_tower": 1, "category+semantic+two_tower": 1}`
...
- strategy: phase_1_15_ablation_no_itemcf_strong
- risk_flags: none
- items:
  ...
  - B0B1FWK1QF score=0.738229 sources=itemcf_weak
...
- items:
  ...
  - B00006IBAK score=1.0 sources=itemcf_weak
...
- items:
  ...
  - 993591786X score=1.202082 sources=itemcf_weak
