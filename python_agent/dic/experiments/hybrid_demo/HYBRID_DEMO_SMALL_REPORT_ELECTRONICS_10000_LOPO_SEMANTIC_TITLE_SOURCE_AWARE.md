...
| candidate_hit_rank_avg | 35.738829 |
| candidate_hit_rank_p50 | 41.0 |
| candidate_hit_rank_p90 | 46.0 |
...
- topk_source_coverage: `{"category": 2127, "itemcf_strong": 1333, "itemcf_weak": 1376, "popular": 4597, "semantic": 1417}`
- per_source_candidate_contribution: `{"category": 45, "itemcf_strong": 1219, "itemcf_weak": 1292, "popular": 62, "semantic": 64}`
- per_source_topk_contribution: `{"category": 44, "itemcf_strong": 990, "itemcf_weak": 1040, "popular": 60, "semantic": 62}`
...
```json
{
  "candidate_generation_avg_seconds": 0.144739,
  "candidate_generation_p95_seconds": 0.334299,
  "ranking_avg_seconds": 0.000375,
  "ranking_p95_seconds": 0.000515,
  "recommendation_avg_seconds": 0.145136,
  "recommendation_p95_seconds": 0.33465,
  "total_run_seconds": 204.487521
}
```
...
- topk_hit_cases: 95
- missed_topk_cases: 1203
- semantic_only_items_above_share: 0.716122
- top1_score_gap_avg: 38.99994
- target_source_combinations: `{"category+itemcf_strong+itemcf_weak": 12, "category+itemcf_strong+itemcf_weak+popular": 12, "category+itemcf_weak+popular": 1, "itemcf_strong": 1, "itemcf_strong+itemcf_weak": 1093, "itemcf_strong+itemcf_weak+popular": 11, "itemcf_strong+itemcf_weak+semantic": 2, "itemcf_weak": 70, "semantic": 1}`
- items_above_source_combinations: `{"semantic": 32209, "popular": 6663, "category+popular": 4495, "itemcf_strong+itemcf_weak": 763, "category+semantic": 405, "category+popular+semantic": 157, "category+itemcf_strong+itemcf_weak+popular": 58, "itemcf_strong+itemcf_weak+semantic": 58, "itemcf_strong+itemcf_weak+popular": 45, "popular+semantic": 27, "category+itemcf_strong+itemcf_weak": 24, "category+itemcf_weak+popular": 15, "itemcf_weak+semantic": 8, "itemcf_strong+popular": 8, "category+itemcf_strong+itemcf_weak+popular+semantic": 7, "itemcf_weak": 7, "category+itemcf_strong+popular": 7, "itemcf_strong+semantic": 6, "itemcf_weak+popular": 5, "category+itemcf_strong": 5, "category+itemcf_weak": 2, "category+itemcf_weak+popular+semantic": 1, "itemcf_strong": 1, "category+itemcf_strong+semantic": 1}`
...
- strategy: phase_1_7_title_semantic_source_aware_demo_10000
- risk_flags: none
- items:
  - B071VDV7NC score=55.048589 sources=category,semantic,popular
  - B087S2JRXY score=51.542975 sources=category,popular
  - B07MZ6PJW8 score=50.0 sources=semantic
  - B07TJ87YKB score=48.8 sources=semantic
  - B09RHJTQTM score=16.5 sources=itemcf_weak,itemcf_strong
...
- risk_flags: none
- items:
  - B01K8B8YA8 score=48.399954 sources=popular
  - B075X8471B score=42.796862 sources=popular
  - B07KTYJ769 score=35.250264 sources=popular
  - B07GZFM1ZM score=33.678481 sources=popular
  - B00KWR8ME2 score=17.75 sources=itemcf_weak,itemcf_strong,category
...
- items:
  ...
  - B07KTYJ769 score=35.250264 sources=popular
  - B07GZFM1ZM score=33.678481 sources=popular
  - 993591786X score=15.181981 sources=itemcf_weak,itemcf_strong
