...
| candidate_hit_rank_avg | 22.543478 |
...
| category_diversity_avg | 2.306122 |
...
- topk_source_coverage: `{"category": 10, "itemcf_strong": 46, "itemcf_weak": 47, "popular": 95, "semantic": 144}`
...
- risk_flags: none
- items:
  - B0020HRE1Y score=80.359368 sources=semantic,popular
  - B001Q9F0BS score=72.937461 sources=semantic,popular
  - B004WMSV76 score=67.6 sources=semantic
  - B09NHSGWPD score=66.4 sources=semantic
  - B08HFNNPPJ score=8.6 sources=itemcf_weak,itemcf_strong,category
...
- risk_flags: none
- items:
  - B0020HRE1Y score=135.559368 sources=semantic,popular
  - B0032AN4N0 score=127.6 sources=semantic
  - B00XI3MMMA score=127.6 sources=semantic
  - B003UT2C4U score=126.4 sources=semantic
...
- risk_flags: none
- items:
  - B00E3W15P0 score=67.6 sources=semantic
  - B0020HRE1Y score=53.959368 sources=semantic,popular
  - B00XI3MMMA score=50.8 sources=semantic
  - B09LYWCHJX score=47.2 sources=semantic
  - B0C8HDXFXN score=7.5 sources=itemcf_weak,itemcf_strong
