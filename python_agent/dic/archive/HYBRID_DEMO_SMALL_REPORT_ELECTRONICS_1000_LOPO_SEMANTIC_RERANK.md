...
| candidate_hit_rank_avg | 24.0 |
| candidate_hit_rank_p50 | 32.0 |
...
- topk_source_coverage: `{"category": 9, "itemcf_strong": 46, "itemcf_weak": 47, "popular": 89, "semantic": 144}`
...
- strategy: phase_1_7_deterministic_semantic_rerank_demo
- risk_flags: none
- items:
  - B0020HRE1Y score=70.359368 sources=semantic,popular
  - B001Q9F0BS score=62.937461 sources=semantic,popular
  - B004WMSV76 score=59.6 sources=semantic
  - B09NHSGWPD score=58.4 sources=semantic
  - B08HFNNPPJ score=6.6 sources=itemcf_weak,itemcf_strong,category
...
- risk_flags: none
- items:
  - B0020HRE1Y score=125.559368 sources=semantic,popular
  - B0032AN4N0 score=119.6 sources=semantic
  - B00XI3MMMA score=119.6 sources=semantic
  - B003UT2C4U score=118.4 sources=semantic
...
- risk_flags: none
- items:
  - B00E3W15P0 score=59.6 sources=semantic
  - B0020HRE1Y score=43.959368 sources=semantic,popular
  - B00XI3MMMA score=42.8 sources=semantic
  - B09LYWCHJX score=39.2 sources=semantic
  - B0C8HDXFXN score=5.5 sources=itemcf_weak,itemcf_strong
