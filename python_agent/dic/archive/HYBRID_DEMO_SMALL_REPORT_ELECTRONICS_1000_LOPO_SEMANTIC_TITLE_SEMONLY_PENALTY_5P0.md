...
| candidate_hit_rank_avg | 24.521739 |
...
| category_diversity_avg | 1.510204 |
...
- topk_source_coverage: `{"category": 77, "itemcf_strong": 46, "itemcf_weak": 47, "popular": 76, "semantic": 145}`
...
- semantic_only_items_above_share: 0.672693
- top1_score_gap_avg: 20.499984
...
- items_above_source_combinations: `{"semantic": 707, "category+semantic": 144, "popular": 119, "category+popular": 35, "category+popular+semantic": 20, "popular+semantic": 18, "itemcf_strong+itemcf_weak": 5, "itemcf_strong+itemcf_weak+popular": 2, "itemcf_strong+itemcf_weak+semantic": 1}`
...
- items:
  ...
  - B08JQCJZQM score=22.6 sources=semantic
  - B0BLCBK97H score=20.2 sources=semantic
  - B071K5BQPF score=19.0 sources=semantic
...
- risk_flags: none
- items:
  - B00E3W15P0 score=14.2 sources=semantic
  - B088DJQ2PQ score=11.8 sources=semantic
  - B08XBLP2V8 score=11.8 sources=semantic
  - B09FN58JBR score=11.8 sources=semantic
