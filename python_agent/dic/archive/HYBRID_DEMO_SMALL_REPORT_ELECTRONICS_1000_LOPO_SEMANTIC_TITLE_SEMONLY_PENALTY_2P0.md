...
| candidate_hit_rank_avg | 24.73913 |
...
| category_diversity_avg | 1.632653 |
...
- topk_source_coverage: `{"category": 52, "itemcf_strong": 46, "itemcf_weak": 47, "popular": 74, "semantic": 145}`
...
- items_above_source_combinations: `{"semantic": 717, "category+semantic": 144, "popular": 119, "category+popular": 35, "category+popular+semantic": 20, "popular+semantic": 18, "itemcf_strong+itemcf_weak": 5, "itemcf_strong+itemcf_weak+popular": 2, "itemcf_strong+itemcf_weak+semantic": 1}`
...
- items:
  ...
  - B08JQCJZQM score=25.6 sources=semantic
  - B08Y1XYLVP score=23.9 sources=category,semantic
  - B0BLCBK97H score=23.2 sources=semantic
  - B071K5BQPF score=22.0 sources=semantic
...
- items:
  ...
  - B0C5MCSLKZ score=28.0 sources=semantic
...
- risk_flags: none
- items:
  - B00E3W15P0 score=17.2 sources=semantic
  - B088DJQ2PQ score=14.8 sources=semantic
  - B08XBLP2V8 score=14.8 sources=semantic
  - B09FN58JBR score=14.8 sources=semantic
