...
def main() -> None:
    ...
    if not args.skip_download:
        run_step(
            ...
            [
                sys.executable,
                str(ROOT / "scripts/data/download_and_clean_amazon.py"),
                "--categories",
                *args.categories,
                "--output-dir",
                str(base_output_dir),
    ...
    run_step(
        ...
        [
            sys.executable,
            str(ROOT / "scripts/data/build_recall_clean_tables.py"),
            "--input-manifest",
            str(manifest_path),
            "--output-dir",
    ...
    run_step(
        ...
        [
            sys.executable,
            str(ROOT / "scripts/data/build_recall_views.py"),
            "--input-dir",
            str(clean_output_dir),
            "--output-dir",
    ...
    run_step(
        ...
        [
            sys.executable,
            str(ROOT / "scripts/data/profile_recall_tables.py"),
            "--clean-stats",
    ...
    run_step(
        ...
        [
            sys.executable,
            str(ROOT / "scripts/data/verify_recall_outputs.py"),
            "--clean-stats",
            str(clean_stats_path),
            "--view-stats",
            str(view_stats_path),
