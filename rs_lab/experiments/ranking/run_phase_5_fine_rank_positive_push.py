...
from rs_lab.experiments.ranking.run_phase_4_stage_shadow_metrics import _weak_ranking_metrics
...
def _command_text(output_dir: Path, limit_users: int | None, seed: int) -> str:
    parts = ["./.venv/Scripts/python.exe", "rs_lab/experiments/ranking/run_phase_5_fine_rank_positive_push.py", "--output-dir", str(output_dir), "--seed", str(seed)]
