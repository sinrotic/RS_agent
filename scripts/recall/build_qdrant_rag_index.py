...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build a candidate-scoped Qdrant RAG chunk collection from item JSONL.")
    parser.add_argument("--items", required=True, help="Item JSONL path, e.g. canonical_items.jsonl")
    parser.add_argument("--collection-name", default=DEFAULT_RAG_CHUNK_COLLECTION)
