...
from rs_core.data import build_mysql_dataset_store_from_env


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Smoke read-only access to the local/trial MySQL dataset wrapper.")
