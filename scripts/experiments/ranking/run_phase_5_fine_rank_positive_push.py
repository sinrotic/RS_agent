...
from scripts.experiments.ranking.run_phase_1_23_pool200_ranking_isolation import FREEZE_FIELDS
from scripts.experiments.ranking.run_phase_1_26_real_ranking_experiments import (
    _not_applicable_feature_contract_gate,
    _not_applicable_leakage_gate,
    _read_frozen_rows,
)
from scripts.experiments.ranking.run_phase_2_fine_rank_algorithm_batch import PHYSICAL_PIPELINE_OVERRIDE
from scripts.experiments.ranking.run_phase_4_stage_shadow_metrics import _weak_ranking_metrics
...
def _command_text(output_dir: Path, limit_users: int | None, seed: int) -> str:
    parts = ["./.venv/Scripts/python.exe", "scripts/experiments/ranking/run_phase_5_fine_rank_positive_push.py", "--output-dir", str(output_dir), "--seed", str(seed)]
