...
| `dic/PHASE_1_25_INDUSTRIAL_RANKING_RESEARCH.md` | 排序侧研究结论 | 不直接迁移到召回结论 | `document_only` | 仅可作为方法边界参考，不混入召回结论 |
...
| 项 | 结果 |
| --- | --- |
| 运行命令 | `.venv/Scripts/python.exe scripts/phase_1_21_recall_coverage_experiments.py --config configs/phase_1_21_recall_coverage_pool200_experimental.yaml --output-dir outputs/phase_1_21_recall_coverage/source_family/worker_cpu_itemcf_covisit_hybrid_pool200 --mode baseline --limit-users 500` |
...
| artifact 根目录 | `outputs/phase_1_21_recall_coverage/source_family/worker_cpu_itemcf_covisit_hybrid_pool200/` |
...
| --- | --- | --- |
| 运行命令 | `.venv/Scripts/python.exe scripts/phase_1_21_recall_coverage_experiments.py --config configs/phase_1_21_recall_coverage_baseline.yaml --output-dir outputs/phase_1_21_recall_coverage/worker_light_20260513/baseline_popular_category --mode baseline --limit-users 500` | `.venv/Scripts/python.exe scripts/phase_1_21_recall_coverage_experiments.py --config configs/phase_1_21_recall_coverage_pool200_experimental.yaml --output-dir outputs/phase_1_21_recall_coverage/worker_light_20260513/itemcf_covisit_pool200 --mode baseline --limit-users 500` |
...
| artifact 根目录 | `outputs/phase_1_21_recall_coverage/worker_light_20260513/baseline_popular_category/` | `outputs/phase_1_21_recall_coverage/worker_light_20260513/itemcf_covisit_pool200/` |
...
| 项 | 结果 |
| --- | --- |
| 运行命令 | `.venv/Scripts/python.exe scripts/phase_1_21_recall_coverage_experiments.py --config configs/phase_1_21_recall_coverage_behavior_untried.yaml --output-dir outputs/phase_1_21_recall_coverage/source_family/worker_behavior_untried_pool200 --mode baseline --limit-users 500` |
| scope | `fixed_contract_candidate_eval` / `recall_only` |
| split | `valid_test` |
| users_total / users_with_holdout | `500 / 138` |
| candidate_pool_size | `200` |
| holdout_user_ids_hash | `927a452a731c7aac912392526fbb39de48388becb4779c0371e4b447ab6446a2` |
| artifact 根目录 | `outputs/phase_1_21_recall_coverage/source_family/worker_behavior_untried_pool200/` |
| 配置 | `configs/phase_1_21_recall_coverage_behavior_untried.yaml` |
| 关键 artifact | `metrics.json`、`manifest.json`、`source_coverage.csv`、`source_family_observation_benchmarks.json`、`frozen_candidates.jsonl` |
...
| 项 | 结果 |
| --- | --- |
| baseline 命令 | `.venv/Scripts/python.exe scripts/phase_1_21_recall_coverage_experiments.py --config configs/phase_1_21_recall_coverage_source_aware.yaml --output-dir outputs/phase_1_21_recall_coverage/source_aware/baseline --mode baseline --limit-users 500` |
| comparison 命令 | `.venv/Scripts/python.exe scripts/phase_1_21_recall_coverage_experiments.py --config configs/phase_1_21_recall_coverage_source_aware.yaml --output-dir outputs/phase_1_21_recall_coverage/source_aware/comparison --mode source-aware --limit-users 500 --holdout-user-ids outputs/phase_1_21_recall_coverage/source_aware/baseline/holdout_user_ids.json` |
| scope | `recall_only_observation` |
| split | `valid_test` |
| users_total / users_with_holdout | `500 / 138` |
| candidate_pool_size | `200` |
| holdout_user_ids_hash | `927a452a731c7aac912392526fbb39de48388becb4779c0371e4b447ab6446a2` |
| artifact 根目录 | `outputs/phase_1_21_recall_coverage/source_aware/` |
| 当前主路复验输出 | `outputs/phase_1_21_recall_coverage/current_main_route_pool200_source_balanced/` |
| 当前主路配置 | `configs/phase_1_21_recall_coverage_pool200_experimental.yaml` |
| 对照配置 | `configs/phase_1_21_recall_coverage_source_aware.yaml` |
...
| 方法族 | 配置 | 输出目录 |
| --- | --- | --- |
| graph | `configs/phase_1_21_recall_coverage_graph.yaml` | `outputs/phase_1_21_recall_coverage/source_family/graph_observation_pool200/` |
| vector / two-tower | `configs/phase_1_21_recall_coverage_vector.yaml` | `outputs/phase_1_21_recall_coverage/source_family/vector_two_tower_observation_pool200/` |
| MF | `configs/phase_1_21_recall_coverage_mf.yaml` | `outputs/phase_1_21_recall_coverage/source_family/mf_observation_pool200/` |
| sequence / multi-interest | `configs/phase_1_21_recall_coverage_sequence.yaml` | `outputs/phase_1_21_recall_coverage/source_family/sequence_multi_interest_observation_pool200/` |
...
| 项目 | 内容 |
| --- | --- |
| 配置 | `configs/phase_1_21_recall_coverage_mf.yaml` |
| 输出目录 | `outputs/phase_1_21_recall_coverage/source_family/mf_implicit_als_bpr_lightfm_pool200/` |
