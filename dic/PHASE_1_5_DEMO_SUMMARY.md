...
| 配置 | 说明 | 输出 |
| --- | --- | --- |
| `configs/hybrid_demo_electronics_1000.yaml` | valid/test + ItemCF Top-K minimum | `outputs/hybrid_demo_small_electronics_1000/` |
| `configs/hybrid_demo_electronics_1000_no_injection.yaml` | valid/test，无 Top-K source minimum 对照 | `outputs/hybrid_demo_small_electronics_1000_no_injection/` |
| `configs/hybrid_demo_electronics_1000_lopo.yaml` | leave-one-positive-out 评估 | `outputs/hybrid_demo_small_electronics_1000_lopo/` |
...
以下建议是 Phase 1.5 结束时的历史判断，后续已由 Phase 1.6 / Phase 1.7 承接；当前最新路线以 `OPTIMIZATION_NARRATIVE.md` 和 `IMPLEMENTATION_PLAN.md` 为准。
