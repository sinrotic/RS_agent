...
| category_diversity_avg | 2.487607 |
...
- topk_source_coverage: `{"category": 1976, "itemcf_strong": 1019, "itemcf_weak": 1045, "popular": 6350, "semantic": 4794, "two_tower": 1689}`
- per_source_candidate_contribution: `{"category": 7, "itemcf_strong": 1, "itemcf_weak": 1, "popular": 15, "semantic": 70, "two_tower": 15}`
- per_source_topk_contribution: `{"category": 2, "popular": 2, "semantic": 15, "two_tower": 1}`
...
```json
{
  ...
  "evidence": {
    ...
    "ranking_p95_seconds": 0.000722,
    "candidate_generation_p95_seconds": 0.402614
  }
}
```
...
```json
{
  "candidate_generation_avg_seconds": 0.17265,
  "candidate_generation_p95_seconds": 0.402614,
  "ranking_avg_seconds": 0.000495,
  "ranking_p95_seconds": 0.000722,
  "recommendation_avg_seconds": 0.173208,
  "recommendation_p95_seconds": 0.403072,
  "total_run_seconds": 66.213688
}
```
...
- semantic_only_items_above_share: 0.582326
- top1_score_gap_avg: 17.130702
...
- strategy: phase_1_17b_rank_weight_popular_0_75
- risk_flags: none
- items:
  - B07MZ6PJW8 score=54.0 sources=semantic
  - B071VDV7NC score=53.798589 sources=category,semantic,popular
...
- risk_flags: none
- items:
  - B01K8B8YA8 score=42.649954 sources=popular
  - B075X8471B score=37.796862 sources=popular
  - B013EKI2DY score=34.703283 sources=semantic,popular
