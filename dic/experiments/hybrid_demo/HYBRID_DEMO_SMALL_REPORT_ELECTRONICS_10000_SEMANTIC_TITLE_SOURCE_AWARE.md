...
| candidate_hit_rank_avg | 15.783333 |
| candidate_hit_rank_p50 | 12.5 |
| candidate_hit_rank_p90 | 33.0 |
...
| category_diversity_avg | 2.333333 |
...
- topk_source_coverage: `{"category": 2979, "itemcf_strong": 998, "itemcf_weak": 1019, "popular": 8809, "semantic": 2380}`
...
```json
{
  "candidate_generation_avg_seconds": 0.139627,
  "candidate_generation_p95_seconds": 0.400739,
  "ranking_avg_seconds": 0.000392,
  "ranking_p95_seconds": 0.000523,
  "recommendation_avg_seconds": 0.14004,
  "recommendation_p95_seconds": 0.401148,
  "total_run_seconds": 331.171092
}
```
...
- semantic_only_items_above_share: 0.746835
- top1_score_gap_avg: 21.840322
- target_source_combinations: `{"category+popular": 6, "itemcf_strong+itemcf_weak": 1, "popular": 2, "semantic": 61}`
- items_above_source_combinations: `{"semantic": 1003, "popular": 170, "category+popular": 125, "category+semantic": 15, "category+popular+semantic": 11, "itemcf_strong+itemcf_weak": 7, "itemcf_strong+itemcf_weak+semantic": 4, "itemcf_strong+itemcf_weak+popular": 3, "category+itemcf_strong+itemcf_weak+popular+semantic": 2, "category+itemcf_strong+itemcf_weak+popular": 1, "itemcf_weak+semantic": 1, "category+itemcf_strong+semantic": 1}`
...
- items:
  ...
  - B005TUQV0E score=15.181981 sources=itemcf_weak,itemcf_strong
...
- items:
  ...
  - B0B23LRBRP score=29.6 sources=semantic
  - B00006IBAK score=14.25 sources=itemcf_weak,itemcf_strong
