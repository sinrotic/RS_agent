...
| category_diversity_avg | 2.478632 |
...
- topk_source_coverage: `{"category": 1979, "itemcf_strong": 1019, "itemcf_weak": 1045, "popular": 6723, "semantic": 4421, "two_tower": 1584}`
- per_source_candidate_contribution: `{"category": 7, "itemcf_strong": 1, "itemcf_weak": 1, "popular": 15, "semantic": 70, "two_tower": 15}`
- per_source_topk_contribution: `{"category": 3, "popular": 4, "semantic": 15, "two_tower": 1}`
...
```json
{
  ...
  "evidence": {
    ...
    "ranking_p95_seconds": 0.000841,
    "candidate_generation_p95_seconds": 0.493285
  }
}
```
...
```json
{
  "candidate_generation_avg_seconds": 0.1961,
  "candidate_generation_p95_seconds": 0.493285,
  "ranking_avg_seconds": 0.000586,
  "ranking_p95_seconds": 0.000841,
  "recommendation_avg_seconds": 0.196711,
  "recommendation_p95_seconds": 0.493944,
  "total_run_seconds": 465.133993
}
```
...
- total_hit_cases: 96
- topk_hit_cases: 20
- missed_topk_cases: 76
- semantic_only_items_above_share: 0.591039
- top1_score_gap_avg: 18.018855
- target_source_combinations: `{"category+popular": 4, "itemcf_strong+itemcf_weak": 1, "popular": 7, "semantic": 50, "semantic+two_tower": 4, "two_tower": 10}`
- items_above_source_combinations: `{"semantic": 1240, "popular": 408, "category+popular": 123, "semantic+two_tower": 113, "two_tower": 110, "itemcf_strong+itemcf_weak": 46, "itemcf_strong": 13, "itemcf_weak": 11, "category+semantic": 7, "category+popular+semantic": 5, "popular+semantic": 4, "popular+two_tower": 4, "category+popular+two_tower": 4, "itemcf_strong+itemcf_weak+semantic": 3, "category+two_tower": 2, "itemcf_strong+semantic": 2, "category+itemcf_strong+itemcf_weak+popular": 1, "itemcf_weak+semantic+two_tower": 1, "itemcf_strong+itemcf_weak+popular": 1}`
...
- strategy: phase_1_18_rank_weight_popular_0_8_two_tower_1_3
- risk_flags: none
- items:
  - B071VDV7NC score=54.048589 sources=category,semantic,popular
...
- items:
  ...
  - B013EKI2DY score=34.953283 sources=semantic,popular
...
- items:
  - B01K8B8YA8 score=44.199954 sources=popular
  - B075X8471B score=39.196862 sources=popular
  - B07W3Q9X9B score=35.702495 sources=semantic,two_tower
  - B0B8SDY8F6 score=35.661871 sources=semantic,two_tower
