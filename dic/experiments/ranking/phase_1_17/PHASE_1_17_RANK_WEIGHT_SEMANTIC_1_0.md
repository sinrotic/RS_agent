...
| candidate_hit_rank_avg | 23.521739 |
| candidate_hit_rank_p50 | 19.0 |
| candidate_hit_rank_p90 | 55.0 |
| candidate_hit_missed_topk_users | 58 |
| ranked_hit_users | 11 |
| recall_at_k | 0.002242 |
...
| category_diversity_avg | 2.138462 |
...
- topk_source_coverage: `{"category": 1915, "itemcf_strong": 1018, "itemcf_weak": 1044, "popular": 9515, "semantic": 1604, "two_tower": 914}`
- per_source_candidate_contribution: `{"category": 7, "itemcf_strong": 1, "itemcf_weak": 1, "popular": 15, "semantic": 70, "two_tower": 15}`
- per_source_topk_contribution: `{"category": 3, "popular": 4, "semantic": 7, "two_tower": 1}`
...
- total_hit_cases: 96
- topk_hit_cases: 13
- missed_topk_cases: 83
- semantic_only_items_above_share: 0.524331
- top1_score_gap_avg: 24.046257
- target_source_combinations: `{"category+popular": 3, "itemcf_strong+itemcf_weak": 1, "popular": 7, "semantic": 58, "semantic+two_tower": 4, "two_tower": 10}`
- items_above_source_combinations: `{"semantic": 1196, "popular": 564, "category+popular": 146, "semantic+two_tower": 116, "two_tower": 110, "itemcf_strong+itemcf_weak": 89, "itemcf_strong": 13, "itemcf_weak": 11, "popular+two_tower": 8, "category+semantic": 7, "popular+semantic": 5, "category+popular+semantic": 5, "itemcf_strong+itemcf_weak+semantic": 3, "category+two_tower": 2, "category+itemcf_strong+itemcf_weak+popular+semantic": 2, "itemcf_strong+semantic": 2, "category+itemcf_strong+itemcf_weak+popular": 1, "itemcf_strong+itemcf_weak+popular": 1}`
...
- strategy: phase_1_17_rank_weight_semantic_1_0
- risk_flags: none
- items:
  - B071VDV7NC score=47.848589 sources=category,semantic,popular
