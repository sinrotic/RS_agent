...
```json
{
  ...
  "source_aware_fusion": {
    ...
    "two_tower_source_boost": 1.2,
    "two_tower_multi_source_boost": 1.0,
    "two_tower_itemcf_source_boost": 1.5,
    "two_tower_semantic_source_boost": 1.0,
    "two_tower_only_penalty": 0.5,
...
| candidate_hit_rank_avg | 43.529412 |
| candidate_hit_rank_p50 | 29.0 |
| candidate_hit_rank_p90 | 120.0 |
...
- topk_source_coverage: `{"category": 511, "category_long_tail_recall": 29, "itemcf_strong": 203, "itemcf_weak": 213, "popular": 1001, "semantic": 1395, "two_tower": 992}`
...
```json
{
  ...
  "evidence": {
    ...
    "ranking_p95_seconds": 0.001636,
    "candidate_generation_p95_seconds": 0.363052
  }
}
```
...
```json
{
  "candidate_generation_avg_seconds": 0.205538,
  "candidate_generation_p95_seconds": 0.363052,
  "ranking_avg_seconds": 0.0012,
  "ranking_p95_seconds": 0.001636,
  "recommendation_avg_seconds": 0.206776,
  "recommendation_p95_seconds": 0.364515,
  "total_run_seconds": 106.02607
}
```
...
- semantic_only_items_above_share: 0.373505
- top1_score_gap_avg: 25.342142
...
- items_above_source_combinations: `{"semantic": 406, "popular": 151, "itemcf_strong+itemcf_weak": 110, "category+popular": 108, "two_tower": 63, "category": 52, "semantic+two_tower": 50, "itemcf_strong": 50, "itemcf_weak": 32, "category_long_tail_recall": 29, "popular+two_tower": 11, "category+popular+two_tower": 9, "category+popular+semantic": 3, "popular+semantic": 2, "category+two_tower": 2, "itemcf_weak+popular": 2, "itemcf_strong+itemcf_weak+semantic": 2, "category_long_tail_recall+itemcf_strong+itemcf_weak": 1, "category_long_tail_recall+itemcf_strong": 1, "itemcf_weak+two_tower": 1, "category_long_tail_recall+semantic": 1, "category+itemcf_strong+itemcf_weak+popular": 1}`
...
- strategy: phase_1_22_pool200_source_aware_fusion
- risk_flags: none
- items:
  - B071VDV7NC score=46.0 sources=category,semantic,popular
  - B087S2JRXY score=42.0 sources=category,popular
  - B07MZ6PJW8 score=41.0 sources=semantic
  - B07TJ87YKB score=40.0 sources=semantic
  - B004GYBR30 score=12.411767 sources=itemcf_weak,itemcf_strong
...
- risk_flags: none
- items:
  - B00P28VN38 score=30.875194 sources=semantic,two_tower
  - B013EKI2DY score=29.0 sources=semantic,popular
  - B01K8B8YA8 score=29.0 sources=popular
  - B075X8471B score=26.0 sources=popular
  - B00006IBAK score=13.0 sources=itemcf_weak,itemcf_strong
...
- risk_flags: none
- items:
  - B07W3Q9X9B score=32.894227 sources=semantic,two_tower
  - B0B8SDY8F6 score=32.862978 sources=semantic,two_tower
  - B0B42DKNL2 score=32.844007 sources=semantic,two_tower
  - B09HZWP8V4 score=31.839867 sources=semantic,two_tower
  - 993591786X score=13.202082 sources=itemcf_weak,itemcf_strong
