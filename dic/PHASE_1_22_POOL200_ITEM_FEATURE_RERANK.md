...
```json
{
  ...
  "item_feature_rerank": {
    ...
    "weights": {
      "multi_source": 1.0,
      "two_tower_source": 0.8,
      "two_tower_multi_source": 1.0,
      "two_tower_itemcf_source": 1.2,
      "two_tower_semantic_source": 1.0,
      "two_tower_only": -0.5,
      "semantic_only": -0.5,
      "popular_only": -0.5,
...
| candidate_hit_rank_avg | 37.823529 |
| candidate_hit_rank_p50 | 28.0 |
...
- topk_source_coverage: `{"category": 499, "category_long_tail_recall": 20, "itemcf_strong": 195, "itemcf_weak": 205, "popular": 957, "semantic": 1438, "two_tower": 930}`
...
```json
{
  ...
  "evidence": {
    ...
    "ranking_p95_seconds": 0.001954,
    "candidate_generation_p95_seconds": 0.362238
  }
}
```
...
```json
{
  "candidate_generation_avg_seconds": 0.208474,
  "candidate_generation_p95_seconds": 0.362238,
  "ranking_avg_seconds": 0.001316,
  "ranking_p95_seconds": 0.001954,
  "recommendation_avg_seconds": 0.209829,
  "recommendation_p95_seconds": 0.364316,
  "total_run_seconds": 107.869734
}
```
...
- semantic_only_items_above_share: 0.410516
- top1_score_gap_avg: 24.390597
...
- items_above_source_combinations: `{"semantic": 406, "popular": 179, "category+popular": 112, "category": 63, "two_tower": 63, "semantic+two_tower": 50, "category_long_tail_recall": 29, "itemcf_strong+itemcf_weak": 26, "itemcf_weak": 15, "itemcf_strong": 13, "popular+two_tower": 11, "category+popular+two_tower": 9, "category+popular+semantic": 3, "popular+semantic": 2, "category+two_tower": 2, "itemcf_weak+popular": 2, "itemcf_strong+itemcf_weak+semantic": 2, "itemcf_weak+two_tower": 1, "category+itemcf_strong+itemcf_weak+popular": 1}`
...
- strategy: phase_1_22_pool200_item_feature_rerank
- risk_flags: none
- items:
  - B071VDV7NC score=47.0 sources=category,semantic,popular
  - B07MZ6PJW8 score=44.5 sources=semantic
  - B07TJ87YKB score=43.5 sources=semantic
  - B087S2JRXY score=43.0 sources=category,popular
  - B004GYBR30 score=1.411767 sources=itemcf_weak,itemcf_strong
...
- risk_flags: none
- items:
  - B00P28VN38 score=31.475194 sources=semantic,two_tower
  - B01K8B8YA8 score=30.5 sources=popular
  - B013EKI2DY score=30.0 sources=semantic,popular
  - B075X8471B score=27.5 sources=popular
  - B00006IBAK score=2.0 sources=itemcf_weak,itemcf_strong
...
- risk_flags: none
- items:
  - B07W3Q9X9B score=33.494227 sources=semantic,two_tower
  - B0B8SDY8F6 score=33.462978 sources=semantic,two_tower
  - B0B42DKNL2 score=33.444007 sources=semantic,two_tower
  - B09HZWP8V4 score=32.439867 sources=semantic,two_tower
  - 993591786X score=2.202082 sources=itemcf_weak,itemcf_strong
