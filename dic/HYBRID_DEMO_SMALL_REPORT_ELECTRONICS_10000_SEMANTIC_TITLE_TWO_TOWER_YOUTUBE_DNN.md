...
| candidate_hit_rank_avg | 15.436364 |
| candidate_hit_rank_p50 | 12.0 |
| candidate_hit_rank_p90 | 35.0 |
| candidate_hit_missed_topk_users | 38 |
| ranked_hit_users | 17 |
| recall_at_k | 0.007758 |
...
| hybrid_hit_rate_at_k | 0.023843 |
| hybrid_no_itemcf_hit_rate_at_k | 0.025245 |
| category_diversity_avg | 2.415812 |
...
- topk_source_coverage: `{"category": 2507, "itemcf_strong": 975, "itemcf_weak": 987, "popular": 7910, "semantic": 3273, "two_tower": 1344}`
- per_source_candidate_contribution: `{"category": 6, "itemcf_strong": 1, "itemcf_weak": 1, "popular": 8, "semantic": 64, "two_tower": 9}`
- per_source_topk_contribution: `{"category": 3, "popular": 4, "semantic": 14, "two_tower": 1}`
...
```json
{
  ...
  "evidence": {
    ...
    "ranking_p95_seconds": 0.000401,
    "candidate_generation_p95_seconds": 0.465984
  },
...
```json
{
  "candidate_generation_avg_seconds": 0.203014,
  "candidate_generation_p95_seconds": 0.465984,
  "ranking_avg_seconds": 0.0003,
  "ranking_p95_seconds": 0.000401,
  "recommendation_avg_seconds": 0.203336,
  "recommendation_p95_seconds": 0.466343,
  "total_run_seconds": 479.227606
}
```
...
- total_hit_cases: 77
- topk_hit_cases: 19
- missed_topk_cases: 58
- semantic_only_items_above_share: 0.639827
- top1_score_gap_avg: 19.339001
- target_source_combinations: `{"category+popular": 3, "itemcf_strong+itemcf_weak": 1, "popular": 1, "semantic": 45, "semantic+two_tower": 4, "two_tower": 4}`
- items_above_source_combinations: `{"semantic": 739, "popular": 147, "semantic+two_tower": 96, "category+popular": 66, "itemcf_strong+itemcf_weak": 50, "two_tower": 17, "category+popular+two_tower": 9, "itemcf_weak": 9, "category+semantic": 7, "category+popular+semantic": 5, "itemcf_strong+itemcf_weak+semantic": 3, "category+semantic+two_tower": 2, "category+two_tower": 2, "category+itemcf_strong+itemcf_weak+popular": 1, "itemcf_weak+semantic+two_tower": 1, "itemcf_strong+itemcf_weak+popular": 1}`
...
- strategy: phase_1_12_two_tower_youtube_dnn_10000_valid_test
- risk_flags: none
- items:
