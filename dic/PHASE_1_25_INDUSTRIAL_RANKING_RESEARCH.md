...
- 产物：`outputs/phase_1_23_pool200_ranking_isolation/comparison.json`、`comparison.md`
...
- 产物：`outputs/phase_1_24_pool200_semantic_near_miss_rescue/comparison.json`、`comparison.md`
