...
| candidate_hit_rank_avg | 22.942029 |
| candidate_hit_rank_p50 | 19.0 |
| candidate_hit_rank_p90 | 55.0 |
| candidate_hit_missed_topk_users | 53 |
| ranked_hit_users | 16 |
| recall_at_k | 0.007391 |
...
| category_diversity_avg | 2.436752 |
...
- topk_source_coverage: `{"category": 1910, "itemcf_strong": 1019, "itemcf_weak": 1045, "popular": 5805, "semantic": 5342, "two_tower": 1815}`
- per_source_candidate_contribution: `{"category": 7, "itemcf_strong": 1, "itemcf_weak": 1, "popular": 15, "semantic": 70, "two_tower": 15}`
- per_source_topk_contribution: `{"category": 1, "popular": 1, "semantic": 15, "two_tower": 1}`
...
```json
{
  ...
  "evidence": {
    ...
    "ranking_p95_seconds": 0.000813,
    "candidate_generation_p95_seconds": 0.46217
  }
}
```
...
```json
{
  "candidate_generation_avg_seconds": 0.178211,
  "candidate_generation_p95_seconds": 0.46217,
  "ranking_avg_seconds": 0.000539,
  "ranking_p95_seconds": 0.000813,
  "recommendation_avg_seconds": 0.178774,
  "recommendation_p95_seconds": 0.462631,
  "total_run_seconds": 422.683047
}
```
...
- total_hit_cases: 96
- topk_hit_cases: 18
- missed_topk_cases: 78
- semantic_only_items_above_share: 0.607446
- top1_score_gap_avg: 17.584696
- target_source_combinations: `{"category+popular": 5, "itemcf_strong+itemcf_weak": 1, "popular": 8, "semantic": 50, "semantic+two_tower": 4, "two_tower": 10}`
- items_above_source_combinations: `{"semantic": 1289, "popular": 381, "category+popular": 121, "semantic+two_tower": 118, "two_tower": 110, "itemcf_strong+itemcf_weak": 46, "itemcf_strong": 13, "itemcf_weak": 11, "category+semantic": 7, "category+popular+semantic": 5, "popular+semantic": 4, "category+popular+two_tower": 4, "itemcf_strong+itemcf_weak+semantic": 3, "popular+two_tower": 3, "category+two_tower": 2, "itemcf_strong+semantic": 2, "category+itemcf_strong+itemcf_weak+popular": 1, "itemcf_weak+semantic+two_tower": 1, "itemcf_strong+itemcf_weak+popular": 1}`
...
- strategy: phase_1_18_rank_weight_popular_0_8_semantic_1_3_two_tower_1_3
- risk_flags: none
- items:
  - B07MZ6PJW8 score=58.5 sources=semantic
  - B071VDV7NC score=57.648589 sources=category,semantic,popular
  - B07TJ87YKB score=57.2 sources=semantic
  - B06Y3WCWXN score=55.9 sources=semantic
...
- risk_flags: none
- items:
  - B01K8B8YA8 score=44.199954 sources=popular
  - B075X8471B score=39.196862 sources=popular
  - B013EKI2DY score=37.353283 sources=semantic,popular
  - B0B23LRBRP score=36.4 sources=semantic
...
- items:
  - B01K8B8YA8 score=44.199954 sources=popular
  - B075X8471B score=39.196862 sources=popular
  - B07W3Q9X9B score=38.602495 sources=semantic,two_tower
  - B0B8SDY8F6 score=38.561871 sources=semantic,two_tower
