...
```json
{
  ...
  "rerank_policy": {
    "enabled": true,
    "semantic_boost": 8.0,
    "multi_source_boost": 2.0,
    "popular_only_penalty": 1.5
  },
...
| candidate_hit_rank_avg | 23.0 |
| candidate_hit_rank_p50 | 31.0 |
...
| category_diversity_avg | 2.285714 |
...
- topk_source_coverage: `{"category": 9, "itemcf_strong": 46, "itemcf_weak": 47, "popular": 91, "semantic": 144}`
...
- risk_flags: none
- items:
  - B0020HRE1Y score=77.359368 sources=semantic,popular
  - B001Q9F0BS score=69.937461 sources=semantic,popular
  - B004WMSV76 score=65.6 sources=semantic
  - B09NHSGWPD score=64.4 sources=semantic
  - B08HFNNPPJ score=7.6 sources=itemcf_weak,itemcf_strong,category
...
- risk_flags: none
- items:
  - B0020HRE1Y score=132.559368 sources=semantic,popular
  - B0032AN4N0 score=125.6 sources=semantic
  - B00XI3MMMA score=125.6 sources=semantic
  - B003UT2C4U score=124.4 sources=semantic
...
- risk_flags: none
- items:
  - B00E3W15P0 score=65.6 sources=semantic
  - B0020HRE1Y score=50.959368 sources=semantic,popular
  - B00XI3MMMA score=48.8 sources=semantic
  - B09LYWCHJX score=45.2 sources=semantic
  - B0C8HDXFXN score=6.5 sources=itemcf_weak,itemcf_strong
