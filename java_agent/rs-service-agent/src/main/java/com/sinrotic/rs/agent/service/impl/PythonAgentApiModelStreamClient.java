...
public class PythonAgentApiModelStreamClient implements AgentModelStreamClient {
    ...
    public PythonAgentApiModelStreamClient(
    ...
    public void streamAssistantEvents(
        ...
        httpClient.streamJson(
                joinUrl(properties.pythonApi().getBaseUrl(), properties.pythonApi().getStreamPath()),
                writeJson(payload),
                "text/event-stream",
    ...
    private AgentModelStreamEvent readEvent(String json) {
        try {
            ...
            throw new IllegalStateException("python agent stream data is not valid JSON", ex);
        }
    }
    ...
    private String writeJson(Object payload) {
        try {
            ...
            throw new IllegalStateException("failed to serialize python agent request", ex);
        }
    }
